...
class SplitterRegistry:
    ...
    Example:
        >>> from atlas.splitter.registry import SplitterRegistry
        >>> from atlas.splitter.cobol import COBOLSplitter
        >>>
        >>> registry = SplitterRegistry()
        >>> registry.register(COBOLSplitter)
        >>>
...
def get_default_registry() -> SplitterRegistry:
    ...
    Example:
        >>> from atlas.splitter.registry import get_default_registry
